window._bd_share_mian ? window._bd_share_is_recently_loaded = !0 : (window._bd_share_is_recently_loaded = !1, window._bd_share_mian = {
	version: "2.0",
	jscfg: {
		domian: {
...
}), !window._bd_share_is_recently_loaded && (window._bd_share_mian.F = window._bd_share_mian.F || function(e, t) {
	function r(e, t) {
	...
	e.each = r, i.currentPath = "", i.loadedPaths = {}, i.loadingPaths = {}, i.cache = {}, i.paths = {}, i.handlers = [], i.moduleFileMap = {}, i.requiredPaths = {}, i.lazyLoadPaths = {}, i.services = {}, i.isPathsLoaded = function(e) {
		...
		load: function() {
			...
			var t = this.svnMod || n,
				r = window._bd_share_mian.jscfg.domian.staticUrl + "static/" + t + "/",
				o = this,
	...
	return h.prototype = {
		domian: window._bd_share_mian.jscfg.domian,
		use: function(t, n) {
			typeof t == "string" && (t = [t]);
...
}({})), !window._bd_share_is_recently_loaded && window._bd_share_mian.F.module("base/min_tangram", function(e, t) {
	var n = {};
...
}), !window._bd_share_is_recently_loaded && window._bd_share_mian.F.module("base/class", function(e, t, n) {
...
}), !window._bd_share_is_recently_loaded && window._bd_share_mian.F.module("conf/const", function(e, t, n) {
	...
	window._bd_share_mian.F._setMod("api"), window._bd_share_mian.F._fileMap({
	...
	}), window._bd_share_mian.F._loadScriptTimeout = 15e3, window._bd_share_mian.F._useConfig = !0, window._bd_share_mian.F._firstScreenCSS = "", window._bd_share_mian.F._firstScreenJS = ""
}(), !window._bd_share_is_recently_loaded && window._bd_share_mian.F.use("base/min_tangram", function(e) {
	function n(e, t, n) {
		var r = new e(n);
		r.setView(new t(n)), r.init(), n && n._handleId && (_bd_share_mian.api = _bd_share_mian.api || {}, _bd_share_mian.api[n._handleId] = r)
	}

	function r(e, r) {
		window._bd_share_mian.F.use(e, function(e, i) {
	...
	var t = e.T;
	_bd_share_mian.init = function(e) {
	...
	}, window._bd_share_mian._LogPoolV2 = [], window._bd_share_mian.n1 = (new Date).getTime(), t.domready(function() {
		window._bd_share_mian.n2 = (new Date).getTime() + 1e3, _bd_share_mian.init(), setTimeout(function() {
			window._bd_share_mian.F.use("trans/logger", function(e) {
				e.nsClick(), e.back(), e.duration()
			})
		}, 3e3)
	})
}), !window._bd_share_is_recently_loaded && window._bd_share_mian.F.module("component/comm_tools", function(e, t) {
	var n = function() {
...
}), !window._bd_share_is_recently_loaded && window._bd_share_mian.F.module("trans/trans", function(e, t) {
	var n = e("component/comm_tools"),
		r = e("conf/const").URLS,
		i = function() {
			window._bd_share_mian.F.use("base/tangram", function(e) {
				var t = e.T;
		...
		o = function(e) {
			var t = (new Date).getTime() + 3e3,
				r = {
					...
					sign: e.bdSign || "on",
					l: window._bd_share_mian.n1.toString(32) + window._bd_share_mian.n2.toString(32) + t.toString(32),
					linkid: n.getLinkId(),
			...
			window._bd_share_mian.F.use("trans/logger", function(t) {
				t.commit(e, r)
			})
		},
		u = function(e, t) {
		...
		l = function(e) {
			window._bd_share_mian.F.use("base/tangram", function(t) {
				var r = t.T;
		...
		h = function() {
			window._bd_share_mian.F.use("trans/trans_bdxc", function(e) {
				e && e.run()
			})
		},
		p = function(e) {
			window._bd_share_mian.F.use("trans/trans_bdysc", function(t) {
				t && t.run(e)
			})
		},
		d = function(e) {
			window._bd_share_mian.F.use("trans/trans_weixin", function(t) {
				t && t.run(e)
			})
		},
		v = function(e) {
